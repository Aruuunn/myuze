import {
  assign, Interpreter, Machine, send, StateMachine,
} from 'xstate';
...
export function getMusicPlayerMachine(
  db: MusicStorageInterface,
  audioService: AudioServiceInterface,
): StateMachine<MusicPlayerMachineContext, any, any> {
  return Machine<MusicPlayerMachineContext>({
    initial: NOT_LOADED,
    context: {
...
export const addMusicPlayListeners = (audioService: AudioServiceInterface,
  musicPlayerService: Interpreter<MusicPlayerMachineContext>): void => {
